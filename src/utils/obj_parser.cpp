...
Object ObjParser::LoadObj(const std::string& filename, const Eigen::Vector3d& translation,
    ...
    Object obj{triangles, translation, rotation};

    return Object{triangles, translation, rotation};
}

std::vector<Eigen::Vector3d> ObjParser::ParseVertices(const std::string& content) {
